...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            $("h4#totalArticleCount").append(data);//h3 tag i içindeki id=# yi alır
        },
        error: function () {
    ...
    $.ajax({
        ...
        dataType: "json",
        success: function (data) {
            $("h4#totalCategoryCount").append(data);
        },
        error: function () {
            toastr.error("Category analizleri yüklenirken sorun oluştu", "Hata");
        }
    });
